package baba.jade.android.com.tablib.apst;
...
public class CustomPagerSlidingTabStrip extends HorizontalScrollView {
  ...
  public CustomPagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.AdvancedPagerSlidingTabStrip);

    indicatorColor =
        a.getColor(R.styleable.AdvancedPagerSlidingTabStrip_apTabIndicatorColor, indicatorColor);
    underlineColor =
        a.getColor(R.styleable.AdvancedPagerSlidingTabStrip_apTabUnderlineColor, underlineColor);
    dividerColor =
        a.getColor(R.styleable.AdvancedPagerSlidingTabStrip_apTabDividerColor, dividerColor);
    indicatorHeight =
        a.getDimensionPixelSize(R.styleable.AdvancedPagerSlidingTabStrip_apTabIndicatorHeight,
            indicatorHeight);
    underlineHeight =
        a.getDimensionPixelSize(R.styleable.AdvancedPagerSlidingTabStrip_apTabUnderlineHeight,
            underlineHeight);
    dividerPadding =
        a.getDimensionPixelSize(R.styleable.AdvancedPagerSlidingTabStrip_apTabDividerPadding,
            dividerPadding);
    tabPadding =
        a.getDimensionPixelSize(R.styleable.AdvancedPagerSlidingTabStrip_apTabPaddingLeftRight,
            tabPadding);
    tabPaddingTopBottom =
        a.getDimensionPixelSize(R.styleable.AdvancedPagerSlidingTabStrip_apTabPaddingTopBottom,
            tabPaddingTopBottom);
    tabBackgroundResId = a.getResourceId(R.styleable.AdvancedPagerSlidingTabStrip_apTabBackground,
        tabBackgroundResId);
    shouldExpand =
        a.getBoolean(R.styleable.AdvancedPagerSlidingTabStrip_apTabShouldExpand, shouldExpand);
    scrollOffset =
        a.getDimensionPixelSize(R.styleable.AdvancedPagerSlidingTabStrip_apTabScrollOffset,
            scrollOffset);
  ...
  public void notifyDataSetChanged() {
    ...
    for (int i = 0; i < tabCount; i++) {
      ...
      if (pager.getAdapter() instanceof CustomTabProvider) {
        View view =
            ((CustomTabProvider) pager.getAdapter()).getSelectTabView(i, getSelectTabView(i));
  ...
  public void setSelectItem(int position) {
    ...
    for (int i = 0; i < tabsContainer.getChildCount(); i++) {
      ...
      if (i == position) {
        ...
        view =
            ((CustomTabProvider) pager.getAdapter()).getDisSelectTabView(i, getDisSelectTabView(i));
