...
public class RvDecoration extends RecyclerView.ItemDecoration {
  ...
  public RvDecoration(int space) {
    this.space = space;
  }

  public RvDecoration(int space, int color) {
    this.space = space;
    this.color = color;
  ...
  public RvDecoration(int space, int color,GRID_TYPE type) {
    this.space = space;
    this.color = color;
    mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    mPaint.setColor(color);
  ...
  public RvDecoration(int space, GRID_TYPE type) {
    this.space = space;
    mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
    mPaint.setStyle(Paint.Style.FILL);
    mPaint.setStrokeWidth(space * 2);
  ...
  public RvDecoration(int space, Drawable mDivider) {
    this.space = space;
