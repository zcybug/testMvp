...
import mvp.android.com.mvplib.model.SimpleResponse;
import mvp.android.com.mvplib.utils.Convert;
...
public abstract class MJsonCallback<T> extends AbsCallback<T> {
    ...
    /**
     * @param types 1: baseEntity里的data默认为String 2: baseEntity里的data默认为T
     */
    public MJsonCallback(int types) {
        this.types = types;
    }
...
//        }
            ...
            try {
                ...
                throw new IllegalStateException("服务访问失败");
            } finally {
                response.close();
            }
