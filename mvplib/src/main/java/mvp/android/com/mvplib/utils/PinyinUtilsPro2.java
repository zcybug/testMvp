...
public class PinyinUtilsPro2 {

    private Context context;
    private Map<String, List<String>> pinyinMap;
    private List<String> pinyin;
    private List<String> hpinyin;

    private static String regx = "(,| |\\[|\\])";// 正则表达式，匹配字符串用

    public PinyinUtilsPro2(Context context) {
     ...
     * @return
     */
    public String getHeadPinyin(String chinese) {
        convertChineseToPinyin(chinese);
