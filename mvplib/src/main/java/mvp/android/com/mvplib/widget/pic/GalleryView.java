...
import static mvp.android.com.mvplib.widget.pic.CommonUtil.dip2px;
import static mvp.android.com.mvplib.widget.pic.CommonUtil.getScreenWidth;
import static mvp.android.com.mvplib.widget.pic.CommonUtil.sp2px;
...
public class GalleryView extends ViewGroup {
     ...
     */
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN) public void init(List<Integer> wList, List<Integer> hList, int spaceW, int spaceH, int loadMoreHeight) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN) private void createLoadMore() {
