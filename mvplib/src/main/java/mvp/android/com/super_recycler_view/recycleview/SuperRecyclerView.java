...
import mvp.android.com.mvplib.utils.NetworkUtils;
...
public class SuperRecyclerView extends RecyclerView {
    ...
    private OnScrollBottomListener onScrollBottomListener = new OnScrollBottomListener() {
        ...
        public void onScorllBootom() {
            if (!NetworkUtils.isNetworkAvailable((Activity)mContext)) {
                ToastUtil.getInstance().showErrMsg(mContext, "请检查网络链接");
                ((LoadingMoreFooter) mLoadMoreFootView).setState(LoadingMoreFooter.STATE_NOWORK);
                ((LoadingMoreFooter) mLoadMoreFootView).footView.setOnClickListener(new View.OnClickListener() {
                    @Override
