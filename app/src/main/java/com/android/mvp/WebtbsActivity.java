...
import lib.android.com.webviewlib.webtbslib.BridgeHandler;
import lib.android.com.webviewlib.webtbslib.CallBackFunction;
import lib.android.com.webviewlib.webtbslib.DefaultHandler;
import lib.android.com.webviewlib.webtbslib.OnShouldOverrideUrlLoading;
import lib.android.com.webviewlib.webtbslib.TbsBridgeWebView;
 ...
 */
public class WebtbsActivity extends Activity implements View.OnClickListener, OnShouldOverrideUrlLoading {
...
//        webView.setCustom("桥名");
        ...
        webView.registerHandler("initSignNetPay", new BridgeHandler() {
            ...
            public void handler(String data, CallBackFunction function) {
                Log.i(TAG, "回传结果：" + data);
                Toast.makeText(WebtbsActivity.this, data, Toast.LENGTH_SHORT).show();
            }
        });
    ...
    @Override
    public boolean onShouldOverrideUrlLoading(com.tencent.smtt.sdk.WebView view, String url) {
        Log.i(TAG, "超链接：" + url);
        return false;
    }
