...
import com.android.mvp.widge.key4.MyKeyboardView;
...
//	private Keyboard k3;
     ...
     * @param edit
     */
    public Key5boardUtil(Context ctx, View parent, EditText edit) {
        this.ctx = ctx;
        this.ed = edit;
        //此处可替换键盘xml
        k1 = new Keyboard(ctx, R.xml.key5_number);
     ...
     * @param edit
     */
    public Key5boardUtil(Context ctx, EditText edit) {
        this.ctx = ctx;
        this.ed = edit;
        //此处可替换键盘xml
        k1 = new Keyboard(ctx, R.xml.key5_number);
