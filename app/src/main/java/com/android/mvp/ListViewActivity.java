...
public class ListViewActivity extends MvpOkgoActivity<TestPresenter, TestView> implements TestView {
  ...
  @OnClick(R.id.kotlin) public void skipKotlin() {
  ...
  @Override protected TestView createView() {
    return this;
  }
  ...
  @Override protected void onActivityCreate(Bundle savedInstanceState) {
    ...
    initList();
    MListAdapter adapter = new MListAdapter(listViewModels, mContext);
  ...
  private class MListAdapter extends MBaseAdapter<ListViewModel> {

    public MListAdapter(List<ListViewModel> list, Context context) {
      super(list, context);
    }
      ...
      showTv.setOnClickListener(new View.OnClickListener() {
        @Override public void onClick(View v) {
          try {
            ...
            intent.setClassName(ListViewActivity.this,
                ListViewActivity.this.getPackageName() + "." + listViewModels.get(position)
                    .getName());
