...
public class MyView extends View {
  ...
  public static enum DrawMode {
    UNKNOWN(0), AXIS(1), ARGB(2), TEXT(3), POINT(4), LINE(5), RECT(6), CIRCLE(7), OVAL(8), ARC(
        9), PATH(10), BITMAP(11);
  ...
  private void drawLine(Canvas canvas) {
    ...
    float[] pts = {
        50, 0, halfWidth, halfDeltaY, halfWidth, halfDeltaY, canvasWidth - 50, 0
    };

    //绘制一条线段
    canvas.drawLine(5, 0, canvasWidth - 50, deltaY / 2, paint);
    XLog.e((canvasWidth - 50) + "===" + (deltaY / 2));
    //绘制一条线段
    canvas.drawLine(20, 100, canvasWidth - 50, 100, paint);
    //绘制折线
    canvas.save();
    canvas.translate(0, deltaY);
