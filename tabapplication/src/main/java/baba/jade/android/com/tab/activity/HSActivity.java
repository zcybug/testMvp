...
public class HSActivity extends AppCompatActivity {
  ...
  private ArrayList<TestFragment> mTabs;//用来存放下方滚动的layout(layout_1,layout_2,layout_3)
  ...
  private void initGroup() {
    ...
    myRadioGroup.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
    ...
    myRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
      @Override public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        mViewPager.setCurrentItem(radioButtonId - _id,
            false);//让下方ViewPager跟随上面的HorizontalScrollView切换
